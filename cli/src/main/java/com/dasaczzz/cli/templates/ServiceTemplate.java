...
public final class ServiceTemplate {
  ...
  public static String generate(String entityName, String basePackage) {
    ...
    return """
        ...
        """.formatted(basePackage, basePackage, basePackage, basePackage, entityName, basePackage, entityName, entityName, entityName, entityName, repoVar, entityName, entityName, entityName, varName, repoVar, varName, entityName, entityName, varName, repoVar, varName, entityName, entityName, varName, repoVar, varName, varName, entityName);
  }
