...
public class LikeController {
  ...
  public ResponseEntity<BaseResponse<String>> deleteRecord(@PathVariable UUID idUser, @PathVariable UUID idPost) {
    return ResponseEntity.ok(likeService.deleteRecord(new IdLike(idUser, idPost)));
  }
